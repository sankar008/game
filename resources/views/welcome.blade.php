...
@section('content')
    ...
    <div class="matka-result">
        ...
        <div class="matka-card live-box">
            ...
            <span class="gn">KALYAN NIGHT</span>
            <span class="gr">256-3</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="gn">MAIN BAZAR</span>
            <span class="gr">122-5</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="live-alert">सबसे तेज सबसे सही</span>
            <span class="gn">OLD MAIN MUMBAI</span>
            <span class="gr">145-0</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="live-alert">सबसे तेज सबसे सही</span>
            <span class="gn">RAJDHANI NIGHT</span>
            <span class="gr">258-5</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="gn">RATAN KHATRI</span>
            <span class="gr">Loading...</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="gn">MAIN MUMBAI RK</span>
            <span class="gr">156-2</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="gn">ROSE BAZAR NIGHT</span>
            <span class="gr">347-4</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="gn">GUJRAT NIGHT</span>
            <span class="gr">136-0</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="gn">MAIN BOMBAY</span>
            <span class="gr">Loading...</span>
            <button onclick="window.location.reload()">Refresh</button>
            <span class="gn">RAJDHANI SUNDAY</span>
            <span class="gr">Loading...</span>
            <button onclick="window.location.reload()">Refresh</button>
            <br>
        </div>
    ...
    <div class="para2" style="margin-bottom: 7px;font-size:16px;padding: 7px;line-height: 25px;color:#b80000;">
        ...
        <hr>
        KALYAN<br>
        <span style="color:#011e76;">03:45 PM to 05:45 PM</span>
        <hr>
        KALYAN NIGHT<br>
        <span style="color:#011e76;">09:20 PM to 11:20 PM</span>
        <hr>
        TIME BAZAR<br>
        <span style="color:#011e76;">01:00 PM to 02:00 PM</span>
        <hr>
        MILAN DAY<br>
        <span style="color:#011e76;">03:00 PM to 05:00 PM</span>
        <hr>
        MILAN NIGHT<br>
        <span style="color:#011e76;">09:00 PM to 11:00 PM</span>
        <hr>
        SRIDEVI<br>
        <span style="color:#011e76;">11:35 AM to 12:35 PM</span>
        <hr>
        SRIDEVI NIGHT<br>
        <span style="color:#011e76;">07:00 PM to 08:00 PM</span>
        <hr>
        SUPREME DAY<br>
        <span style="color:#011e76;">03:35 PM to 05:35 PM</span>
        <hr>
        SUPREME NIGHT<br>
        <span style="color:#011e76;">08:45 PM to 10:45 PM</span>
    </div>
    <div>
    ...
    <div class="satta-result" style="border-color: #aa00c0;margin-bottom: 2px;">
        <div>
            <h4>MILAN MORNING</h4>
            <span>128-11-227</span>
            <p>10:15 AM &nbsp;&nbsp; 11:15 AM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>SRIDEVI</h4>
            <span>334-02-688</span>
        ...
        <div>
            <h4>MAHARANI</h4>
            <span>126-90-668</span>
            <p>12:15 PM &nbsp;&nbsp; 02:15 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MUMBAI MORNING</h4>
            <span>478-92-156</span>
        ...
        <div>
            <h4>DIAMOND</h4>
            <span>159-59-478</span>
            <p>01:10 PM &nbsp;&nbsp; 02:40 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>TARA MUMBAI DAY</h4>
            <span>126-99-289</span>
        ...
        <div class="yellowbg">
            <h4>MAIN BAZAR</h4>
            <span>122-5</span>
            <p>09:40 PM &nbsp;&nbsp; 12:05 AM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MAHARANI DAY</h4>
            <span>128-11-290</span>
            <p>05:15 PM &nbsp;&nbsp; 07:15 PM</p>
            <a href="jodi/maharani-day.php" class="result_timing btn_chart">Jodi</a>
            <a href="panel/maharani-day.php" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>SRIDEVI DAY</h4>
            <span>788-31-669</span>
            <p>01:30 PM &nbsp;&nbsp; 02:30 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        ...
        <div>
            <h4>MAIN MORNING</h4>
            <span>Off</span>
            <p>12:05 PM &nbsp;&nbsp; 01:30 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>KALYAN PRO</h4>
            <span>123-68-279</span>
        ...
        <div>
            <h4>SOPHIE DAY</h4>
            <span>590-42-147</span>
            <p>01:40 PM &nbsp;&nbsp; 03:40 PM</p>
            <a href="jodi/sophie-day.php" class="result_timing btn_chart">Jodi</a>
            <a href="panel/sophie-day.php" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>GUJRAT</h4>
            <span>390-22-147</span>
        ...
        <div class="yellowbg">
            ...
            <span>145-0</span>
            <p>09:30 PM &nbsp;&nbsp; 12:05 AM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>RAJLAXMI</h4>
            <span>367-67-557</span>
        ...
        <div>
            ...
            <span>250-7</span>
            <p>08:30 PM &nbsp;&nbsp; 10:30 PM</p>
            <a href="jodi/madhur-night.php" class="result_timing btn_chart">Jodi</a>
            <a href="panel/madhur-night.php" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>SOPHIE NIGHT</h4>
            <span>700-7</span>
            <p>08:40 PM &nbsp;&nbsp; 10:40 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div class="yellowbg">
            <h4>RATAN KHATRI</h4>
            <span>356-47-368</span>
        ...
        <div>
            <h4>SUNDAY BAZAR</h4>
            <span>689-32-246</span>
            <p>12:30 PM &nbsp;&nbsp; 02:30 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            ...
            <span>570-2</span>
            <p>08:00 PM &nbsp;&nbsp; 10:30 PM</p>
            <a href="#"class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>KUBER</h4>
            <span>234-96-268</span>
        ...
        <div>
            <h4>BALAJI</h4>
            <span>255-26-123</span>
            <p>02:10 PM &nbsp;&nbsp; 03:10 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
    </div>
    <div class="satta-result" style="border-color: #aa00c0;margin-bottom: 2px;">
        ...
        <div>
            <h4>RAMJI DAY</h4>
            <span>478-97-124</span>
            <p>01:35 PM &nbsp;&nbsp; 03:35 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>SITA MORNING </h4>
            <span>334-01-146</span>
            <p>09:45 AM &nbsp;&nbsp; 10:45 AM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>RAJSHREE MORNING</h4>
            <span>124-75-159</span>
            <p>11:35 AM &nbsp;&nbsp; 12:35 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>RAJSHREE</h4>
            <span>139-34-149</span>
            <p>01:35 PM &nbsp;&nbsp; 02:35 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>KESARI MORNING</h4>
            <span>580-35-168</span>
            <p>11:20 PM &nbsp;&nbsp; 12:20 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>SRILAKSHMI</h4>
            <span>180-90-145</span>
            <p>11:20 AM &nbsp;&nbsp; 12:20 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>LAXMI BAZAR</h4>
            <span>347-40-235</span>
            <p>01:25 PM &nbsp;&nbsp; 03:25 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MILAN BAZAR</h4>
            <span>147-24-149</span>
            <p>03:45 PM &nbsp;&nbsp; 05:45 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>JANTA BAZAR DAY</h4>
            <span>360-98-279</span>
            <p>01:15 PM &nbsp;&nbsp; 03:15 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>JANTA BAZAR NIGHT</h4>
            <span>268-6</span>
            <p>08:45 PM &nbsp;&nbsp; 10:45 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        ...
        <div>
            <h4>SUPER RATAN MORNING</h4>
            <span>369-86-240</span>
            <p>11:30 AM &nbsp;&nbsp; 12:30 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>SUPER RATAN DAY</h4>
            <span>127-04-149</span>
            <p>01:30 PM &nbsp;&nbsp; 03:00 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>SUPER RATAN NIGHT</h4>
            <span>167-4</span>
            <p>08:30 PM &nbsp;&nbsp; 10:30 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        ...
        <div>
            ...
            <a href="jodi/rose-bazar-night.php" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>JANTA MORNING</h4>
            <span>258-52-138</span>
            <p>01:00 PM &nbsp;&nbsp; 02:00 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        ...
        <div>
            <h4>SUPER TIME</h4>
            <span>190-06-150</span>
            <p>12:55 PM &nbsp;&nbsp; 01:55 PM</p>
            <a href="jodi/super-time.php" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MAYA BAZAR</h4>
            <span>157-37-160</span>
            <p>01:30 PM &nbsp;&nbsp; 02:30 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        ...
        <div>
            <h4>KAALI</h4>
            <span>126-92-480</span>
            <p>10:45 PM &nbsp;&nbsp; 12:45 AM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MAIN KALYAN DAY</h4>
            <span>690-52-480</span>
            <p>01:10 PM &nbsp;&nbsp; 03:10 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            ...
            <span>339-5</span>
            <p>09:10 PM &nbsp;&nbsp; 10:10 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>SAGAR DAY</h4>
            <span>900-90-550</span>
    ...
    <div class="satta-result" style="border-color: #aa00c0;margin-bottom: 2px;">
        <div>
            <h4>TEEN PATTI OLD</h4>
            <span>130-44-257</span>
            <p>08:05 PM &nbsp;&nbsp; 09:05 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>RAJDHANI DAY</h4>
            <span>226-06-349</span>
        ...
        <div>
            ...
            <span>177-58-567</span>
            <p>11:00 PM &nbsp;&nbsp; 01:00 AM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
        ...
        <div>
            <h4>MAHAKALI DAY</h4>
            <span>369-89-568</span>
            <p>11:10 AM &nbsp;&nbsp; 12:10 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MAHAKALI NIGHT</h4>
            <span>680-44-356</span>
            <p>07:00 PM &nbsp;&nbsp; 08:00 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        ...
        <div>
            <h4>KALYAN BAZAR</h4>
            <span>569-08-189</span>
            <p>02:10 PM &nbsp;&nbsp; 04:10 PM</p>
            <a href="jodi/kalyan-bazar.php" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MAIN BAZAR MORNING</h4>
            <span>239-43-580</span>
        ...
        <div>
            <h4>MAIN GOA DAY</h4>
            <span>140-55-230</span>
            <p>03:00 PM &nbsp;&nbsp; 05:00 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MAIN GOA NIGHT</h4>
            <span>288-85-113</span>
            <p>09:00 PM &nbsp;&nbsp; 11:00 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        ...
        <div>
            <h4>DHAN BAZAR DAY</h4>
            <span>346-32-156</span>
            <p>12:10 PM &nbsp;&nbsp; 02:10 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>DHAN BAZAR NIGHT</h4>
            <span>127-08-378</span>
            <p>07:45 PM &nbsp;&nbsp; 08:45 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>GOWA</h4>
            <span>379-97-250</span>
            <p>12:30 PM &nbsp;&nbsp; 02:25 PM</p>
            <a href="#" class="result_timing btn_chart">Jodi</a>
            <a href="#" class="result_timing_right btn_chart">Panel</a>
        </div>
        <div>
            <h4>MILAN BAZAR MORNING</h4>
            <span>588-11-470</span>

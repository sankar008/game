...
```
cd existing_repo
git remote add origin https://gitlab.com/sankar008/laraveladmin.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sankar008/laraveladmin/-/settings/integrations)
